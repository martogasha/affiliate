...
<head>
    <meta charset="utf-8">
    <title>Sign Ups - Affiliate Website</title>
                        ...
                        <div class="col-md-12 clearfix">
                            <nav id="main-nav">
                                ...
                                <ul class="menu clearfix">
                                    ...
                                    <li><a href="{{url('signUp')}}" style="color:green">Sign Ups</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-9 col-sm-8 col-xs-12 main-content">
                            ...
                            <div class="category-item-container">
                                ...
                                <div class="container">
                                    <table>
                                        <caption style="color: #0a0a0a">Signed Up People</caption>
                                        <thead>
                                        <tr>
                                        ...
                                        <tr>
                                            <td data-label="Account">{{$contact->name}}</td>
