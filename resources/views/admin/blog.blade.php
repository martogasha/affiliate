                                    ...
                                    <div class="row flex">
                                        @foreach($contents as $content)
                                            <div class="col-lg-4 col-sm-6">
                                                <div class="thumbnail">
                                                    <img src="{{asset('uploads/product/'.$content->image)}}">
                                                    <h4>{{\Illuminate\Support\Str::of($content->title)->words(7)}}</h4>
                                                </div>
                                                <a href="{{url('blogDetail',['id'=>$content->id,'name'=>str_slug($content->title)])}}"><button class="btn btn-primary">View</button></a>
                                                <a href="{{url('editBlog',$content->id)}}"><button class="btn btn-info">Edit</button></a>
